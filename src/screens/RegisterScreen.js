...
export default function RegisterScreen({ navigation }) {
  ...
  const handleRegister = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch('https://streamvibe-server.onrender.com/api/auth/register', {
        method: 'POST',
    ...
    <LinearGradient colors={['#1a0000', '#0f0f0f', '#000']} style={styles.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.inner}>
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.title}>Join StreamVibe</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 32, fontWeight: 'bold', color: '#ff4444', marginBottom: 8 },
